    ...
    public function run(): void
    {
        $email_jobs = [
            ...
            [
                ...
                'cover_image' => null,
                'greeting_text' => '<p>Hi {referred_name},</p>',
                'upper_text' => '<p>Are you ready to unlock the wealth in your home? You have been recommended for a Household Loan by {referrer_name}.</p><p>Accessing your home equity can provide you with the retirement you’ve always hoped for. A Household Loan allows you to remain in the home you love while living your best life: renovate, travel, establish a contingency fund for the unexpected or simply have more in your pocket each week.</p><p>We invite you to improve your retirement lifestyle and, if a Household Loan is right for you, we are offering a $500 reward upon settlement in 2023. Plus {referrer_name} will also be rewarded.</p><p><b>Confirm eligibility</b></p><p>Use our online <a href="'.config('app.url').'/refer-friend-eligibility">calculator</a> to see your accessible Household Capital.</p><p><b>Personal Consultation</b></p><p>Experience one-on-one personalised service with a retirement specialist.</p><p><b>Application</b></p><p>We guide you through every step of the loan application process.</p><p>Upon settlement of your Household Loan, you will be sent your $500 Digital Prepaid Mastercard via email.</p><p>We look forward to talking with you soon. If you have any questions, please call us on <a href="tel:1300 463 082">1300 463 082</a> or check the <a href="https://householdcapital.com.au/website-privacy-policy/">Terms & Conditions</a>.</p><p>Warm regards</p><p>Jay Sewell</p><p>Customer & Operations Lending Director</p>',
                'button_text'=> null,
                'button_url' => null,
                'lower_text' => null,
            ],
            ...
            [
                ...
                'cover_image' => null,
                'greeting_text' => '<p>Hi {referred_name},</p>',
                'upper_text' => '<p>We are sending you a reminder that you have been recommended for a Household Loan by {referrer_name}.</p><p>We are offering a $500 reward upon settlement in 2023. Your friend {referrer_name} will also receive a reward!</p><p>We invite you to enhance your retirement lifestyle and, if a Household Loan is right for you, you will receive this reward as a Digital Prepaid Mastercard sent via email after settlement. To get a reward, you need to complete the following simple steps.</p><ul><li>The first step is to visit <a href="'.config('app.url').'/refer-friend-eligibility">rewards.householdcapital.com</a> and complete our home equity calculator and provide your contact information; we’ll contact you to discuss your eligibility.</li><li>The second step is a personalised meeting with one of our retirement specialists.</li><li>The third step is the application process - there’s always someone available to help you along the way.</li></ul><p>Please call us on <a href="tel:1300 463 082">1300 463 082</a> or check the <a href="https://householdcapital.com.au/website-privacy-policy/">Terms & Conditions</a>.</p><p>Warm regards</p><p>Jay Sewell</p><p>Customer & Operations Lending Director</p>',
                'button_text'=> null,
                'button_url' => null,
                'lower_text' => null,
            ],
            ...
            [
                ...
                'button_text'=> null,
                'button_url' => null,
                'lower_text' => '<p>We are offering a reward if you settle a Household Loan with us in 2023. Upon settlement, you will be sent a $500 reward to spend as you please.</p><p>The next steps are...</p><p>Personal Consultation</b></p><p>Experience one-on-one personalised service with a retirement specialist.</p><p><b>Loan application</b></p><p>We guide you through every step of the application process.</p><p><b>Be rewarded</b></p><p>We will send you a $500 Digital Prepaid Mastercard  if you settle a loan with us in 2023</p><p>Warm regards</p><p>Jay Sewell</p><p>Customer & Operations Lending Director</p>',
            ],
        ];
