...
class EligibilityEmailTwoJob implements ShouldQueue
{
    ...
    {
        if ($this->referred->reward_status === 'eligibility_email_1_sent' && $this->referred->referrer) {
            ...
            $this->referred->emailJobs()->create(['email_type' => 'eligibility_email_3', 'scheduled_date_time' => $mail->scheduled_date_time->addDays(5)]);
