...
<template>
    <div>
        <button :class="'w-full font-anton text-lg p-3 text-primary-dark text-left flex items-center '+(state.open ? ' bg-primary-light hover:bg-[#dddddd]' : '')" @click="$emit('toggleOpen', state.id)">
