...
import Item from "./FAQComponents/Item.vue";
...
export default {
  ...
  data() {
    // hardcoded for now, could be set dynamically in future
    const listContent = [
      {
        ...
        title:'How do I receive the reward? ',
        content:`
        ...
        title: 'What reward am I entitled to? ',
        content: `
        ...
        title: 'I haven’t received my gift card. What do I do?',
        content: `
          <div>
        ...
        title: 'How do I use/ activate my Digital Prepaid Mastercard?',
        content: `
        ...
        title: 'Do I need to spend the full value of my Digital Prepaid Mastercard in one transaction or with one retailer? ',
        content: 'No. You can choose how and where you spend the funds on your Digital Prepaid Mastercard. Any remaining balance after a transaction will remain on your Digital Prepaid Mastercard if it has not reached its expiry date.  '
      }, {
        title: 'My phone doesn’t have a digital wallet.',
        content: 'Consider gifting the Digital Prepaid Mastercard to a family member or friend. Before it is downloaded you will need to forward the SMS to their mobile number, then they can then follow the instructions to download the Digital Prepaid Mastercard. '
      }, {
        title: 'How do I check my balance?',
        content: 'You can check your balance via the TCN mobile app.'
      }, {
        title: 'If my transaction is greater than the amount on my Digital Prepaid Mastercard, can I pay the rest with cash or credit card?',
        content: 'Yes, you can. You may need to request a split payment from the cashier.'
      }, {
        title: 'Can I reload my Digital Prepaid Mastercard?',
        content: 'No, Digital Prepaid Mastercard’s are not reloadable.'
      }, {
        title: 'What if my Digital Prepaid Mastercard is not accepted for payment?',
        content: `
        ...
        title: 'What happens if I have not used the entire value of my Digital Prepaid Mastercard and it has expired? ',
        content: 'Once the Digital Prepaid Mastercard has expired, the remaining value will no longer be available.'
      }, {
        title: 'What do I do if my Digital Prepaid Mastercard is stolen, lost or is damaged? ',
        content: 'Digital Prepaid Mastercard’s should be treated like cash and kept in a secure place. Unfortunately, we cannot replace a Digital Prepaid Mastercard under any circumstances. '
      }, {
        title: 'I have an additional query, who do I contact?',
        content: `
          <div>
      ...
      return {
          ...
          items: listContent.map((value, index) => {
            return {
                open: index === 0, 
                id: index, ...value
            } 
